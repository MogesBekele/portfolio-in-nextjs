...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className={ `w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50  ${isSroll? 'bg-white bg-opacity-50 backdrop-blur-lg shadow-sm':""}`}>
        <a href="#top">
          <Image
            src={assets.logo}
            alt=""
        ...
        <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isSroll?"":" bg-white shadow-sm bg-opacity-50 "}`}>
          <li>
            <a href="#top">Home</a>
          </li>
          <li>
