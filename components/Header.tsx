...
const Header = () => {
  return (
    <div>
      ...
      <h3 className="flex items-center gap-2 text-xl md:text-2xl mb-3 font-font-ovo ">
        Hi I'm Moges Bekele
        <Image src={assets.hand_icon} alt="" className="w-6" />
      </h3>
      <h1 className="text-3xl sm:text-6xl lg:text-[66px] ">Fullstack developer based on Ethoipia</h1>
      <p className="max-w-2xl mx-auto ">I am Fullstack developer from Ethoipia </p>
