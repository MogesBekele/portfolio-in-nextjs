...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'tailwindcss  JavaScript, typescript, React Js, Next Js, nodejs, expressjs, mongoDB ' },
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Education', description: 'Fullstack depelopement, B.s in Elecromechanical Engineering' },
